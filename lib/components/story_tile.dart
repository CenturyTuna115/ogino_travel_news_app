...
class Stories {
  final List _stories = [
    ['assets/story1.png', 'Top distanation to go in Japan ', '45,932'],
    ['assets/story2.png', 'Discover the Halloween district of Japan', '54,045'],
    [
      'assets/post3.png',
      'Explore USJR: The new campus launch !!',
      '54,045'
    ]
  ];
}
